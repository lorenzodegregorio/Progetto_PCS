...
TEST(TestImport, TestImportSegments){
    ...
    string nomefile_punti = "C:\\Users\\acer\\Desktop\\progetto_PCS\\Projects\\Raffinamento\\Dataset\\Test1\\Cell0Ds.csv";
    ProjectLibrary::ImportPoints(nomefile_punti,punti);


    vector<ProjectLibrary::Segment> lati;

    string nomefile_lati = "C:\\Users\\acer\\Desktop\\progetto_PCS\\Projects\\Raffinamento\\Dataset\\Test1\\Cell1Ds.csv";
...
TEST(TestImport, TestImportCells){
    ...
    string nomefile_celle = "C:\\Users\\acer\\Desktop\\progetto_PCS\\Projects\\Raffinamento\\Dataset\\Test1\\Cell2Ds.csv";
